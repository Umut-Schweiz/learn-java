...
public class StringMethod02 {
    ...
    public static void main(String[] args) {
        // 1. starsWith() methodu ilk characteri kontrol eder
        ...
        // 2. methods   indexOf() methodu soldan sağa doğru giderken ilk görünümün indexini verir. H==> 0  0 dan başlıyor
        ...
        //3. lastIndex0f() methodu son gorunumun index'ini verir.
        ...
        //4. substring() bir String'in belli bir bölümünü kesip almaya yarar(ÖNEMLİ)(ÇOK KULLANILIR)
        String c = "Karakartal";
        ...
        //5. trim() methodu bir String'in bas ve son taraflarındaki space'leri siler.
