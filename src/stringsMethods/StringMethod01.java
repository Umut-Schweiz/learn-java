...
public class StringMethod01 {
    ...
    public static void main(String[] args) {
	    ...
	    */
        ...
        System.out.println(u.endsWith("")); // true çünkü String hiç bir şeyle biter.
        ...
        System.out.println(b.replace(' ', '*'));//Java*1257*?!@$_      char kullanarak yapıldı.
        ...
        System.out.println(first==numberUser);//false
        System.out.println(first.equals(numberUser));//true

        scan.close();

        //10. Method equalsIgnoreCase()  arka planda java toUpperCase veya toLowerCase i çalıştırıyor

        String da = "suleyman";
        String eb = "SULEYMAN";
        String fc = "Suleyman";

        System.out.println(da.equalsIgnoreCase(eb));//true
        System.out.println(eb.equalsIgnoreCase(fc));//true
    }
}